...
function getRandomQuote(x) {
	...
	if (x == "HS") {
		y = [
			"You don't know what it's like to be me<br>I would die for you, it's that deep<br>and you don't know what it's like to be me<br>It's so cold at night when I can't sleep<br>and you don't know what it's like to be me<br>it gets old when it's right there but I can't reach",
		...
		y = [
			"Now my heart sags like my eyelids sink<br>You asking what did I mean<br>To be honest, not to deceive<br>Messing up more, trying to brush it off my sleeve<br>so I stuck it on a beat<br>I been like this since I was sucking on a teat",
		...
		y = [
			"Why are we here?<br>Why weren't you there?<br>Why should I care?<br>Why's my grandmama dead?<br>Why'd she have MS?<br>Why I feel this stress?<br>Why I don't feel blessed?<br>Why I shouldn't fear death",
		...
		y = [
			"You're a shadow, You're a ghoul<br>You're the chair in my room<br>You're the air I consume<br>You're the glare in my screen, you're the prophet of doom",
